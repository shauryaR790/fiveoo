    ...
    >
      <div className="grid grid-cols-1 items-start gap-16 md:grid-cols-2 md:gap-14 lg:gap-24">
        <div className="mt-[7px] md:-mt-[3px] lg:-mt-px">
          <h2
            data-process-reveal
            className="font-display m-0 max-w-[8ch] text-[clamp(4rem,9vw,8.5rem)] font-extrabold uppercase leading-[0.88] tracking-[-0.055em] text-[var(--color-fg)] md:sticky md:top-24"
          >
        ...
        <div className="theme-card theme-divide-y w-full overflow-hidden rounded-2xl">
          {PROCESS_STEPS.map((step) => (
            ...
            >
              ...
              <div>
                <h3 className="mb-4 text-[20px] font-semibold leading-[1.25] tracking-[-0.03em] text-[var(--color-fg)] md:mb-5 md:text-[24px]">
                  {step.title}
                </h3>
                <p className="max-w-[36rem] text-[16px] font-normal leading-[1.55] tracking-[-0.015em] text-[var(--color-fg)]/55 md:text-[18px]">
                  {step.description}
                </p>
              </div>
            </div>
